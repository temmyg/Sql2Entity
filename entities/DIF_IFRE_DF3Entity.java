...
@Entity
@Table(name="DIF_IFRE_DF3")
public class DIF_IFRE_DF3Entity {
	...
	@DataField(pos = 17)
	private Double return_of_Capital;
	public Double getReturn_of_Capital() {
		return return_of_Capital;
	}
	public void setReturn_of_Capital(Double return_of_Capital) {
		this.return_of_Capital = return_of_Capital;
	}
	...
	@DataField(pos = 25)
	private String sold_Investments;
	public String getSold_Investments() {
		return sold_Investments;
	}
	public void setSold_Investments(String sold_Investments) {
		this.sold_Investments = sold_Investments;
	}
	...
	@DataField(pos = 27)
	private Double temporary_Return_of_Capital;
	public Double getTemporary_Return_of_Capital() {
		return temporary_Return_of_Capital;
	}
	public void setTemporary_Return_of_Capital(Double temporary_Return_of_Capital) {
		this.temporary_Return_of_Capital = temporary_Return_of_Capital;
	}

	@DataField(pos = 28)
	private Double permanent_Return_of_Capital;
	public Double getPermanent_Return_of_Capital() {
		return permanent_Return_of_Capital;
	}
	public void setPermanent_Return_of_Capital(Double permanent_Return_of_Capital) {
		this.permanent_Return_of_Capital = permanent_Return_of_Capital;
	}
