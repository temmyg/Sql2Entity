...
@Entity
@Table(name="DIF_IFRE_ALPHOL")
public class DIF_IFRE_ALPHOLEntity {
	...
	@DataField(pos = 5)
	private Double local_Value_of_Asset;
	public Double getLocal_Value_of_Asset() {
		return local_Value_of_Asset;
	}
	public void setLocal_Value_of_Asset(Double local_Value_of_Asset) {
		this.local_Value_of_Asset = local_Value_of_Asset;
	}
	...
	@DataField(pos = 7)
	private Double local_Value_of_Debt;
	public Double getLocal_Value_of_Debt() {
		return local_Value_of_Debt;
	}
	public void setLocal_Value_of_Debt(Double local_Value_of_Debt) {
		this.local_Value_of_Debt = local_Value_of_Debt;
	}

	@DataField(pos = 8)
	private Double local_Cost_of_Equity;
	public Double getLocal_Cost_of_Equity() {
		return local_Cost_of_Equity;
	}
	public void setLocal_Cost_of_Equity(Double local_Cost_of_Equity) {
		this.local_Cost_of_Equity = local_Cost_of_Equity;
	}

	@DataField(pos = 9)
	private Double local_Value_of_Equity;
	public Double getLocal_Value_of_Equity() {
		return local_Value_of_Equity;
	}
	public void setLocal_Value_of_Equity(Double local_Value_of_Equity) {
		this.local_Value_of_Equity = local_Value_of_Equity;
	}
	...
	@DataField(pos = 11)
	private Double cdn_Value_of_Asset;
	public Double getCdn_Value_of_Asset() {
		return cdn_Value_of_Asset;
	}
	public void setCdn_Value_of_Asset(Double cdn_Value_of_Asset) {
		this.cdn_Value_of_Asset = cdn_Value_of_Asset;
	}
	...
	@DataField(pos = 13)
	private Double cdn_Value_of_Debt;
	public Double getCdn_Value_of_Debt() {
		return cdn_Value_of_Debt;
	}
	public void setCdn_Value_of_Debt(Double cdn_Value_of_Debt) {
		this.cdn_Value_of_Debt = cdn_Value_of_Debt;
	}

	@DataField(pos = 14)
	private Double cdn_Cost_of_Equity;
	public Double getCdn_Cost_of_Equity() {
		return cdn_Cost_of_Equity;
	}
	public void setCdn_Cost_of_Equity(Double cdn_Cost_of_Equity) {
		this.cdn_Cost_of_Equity = cdn_Cost_of_Equity;
	}

	@DataField(pos = 15)
	private Double cdn_Value_of_Equity;
	public Double getCdn_Value_of_Equity() {
		return cdn_Value_of_Equity;
	}
	public void setCdn_Value_of_Equity(Double cdn_Value_of_Equity) {
		this.cdn_Value_of_Equity = cdn_Value_of_Equity;
	}
